...
public class SingleProducerSequencer implements Sequencer
{
    ...
    {
        return hasAvailableCapacity(availableCapacity, gatingSequences);
    }
    ...
    private long checkAndIncrement(int availableCapacity, int delta, Sequence[] dependentSequences) 
    ...
    private boolean hasAvailableCapacity(final int availableCapacity, final Sequence[] dependentSequences)
    {
