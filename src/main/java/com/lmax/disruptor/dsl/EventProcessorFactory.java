 ...
 *
 * <pre><code>
 * disruptor.handleEventsWith(handler1).then((barrierSequences) -> new CustomEventProcessor(barrierSequences));
 * </code></pre>
 */
public interface EventProcessorFactory
{
     ...
     */
    EventProcessor createEventProcessor(Sequence[] barrierSequences);
}
