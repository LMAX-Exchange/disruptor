 ...
 */
public class OffHeapRingBuffer implements Sequencer, Publisher
{
    ...
    private OffHeapRingBuffer(Object buffer, long address, 
                              int bufferSize, int chunkSize, 
                              Sequence cursor, Sequencer sequencer,
    ...
    public static OffHeapRingBuffer newInstance(int bufferSize, int chunkSize, WaitStrategy waitStrategy)
    {
        ...
        return new OffHeapRingBuffer(buffer, address, bufferSize, chunkSize, 
                                     sequencer.getCursorSequence(), sequencer, 
                                     waitStrategy);
    }
    ...
    {
        return sequencer.claim(sequence);
    }
