...
{
    private static final VarHandle AVAILABLE_ARRAY;

    static
    {
        try
        {
            AVAILABLE_ARRAY = MethodHandles.arrayElementVarHandle(int[].class);
        }
    ...
    public boolean isAvailable(long sequence)
    {
        ...
        return flag == (int) AVAILABLE_ARRAY.getVolatile(availableBuffer, index);
    }
