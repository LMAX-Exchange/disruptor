...
abstract class RingBufferFieldsArray<E> extends RingBufferPad {
    ...
    RingBufferFieldsArray(final EventFactory<E> eventFactory, final Sequencer sequencer) {
...
public final class RingBufferArray<E> extends RingBufferFieldsArray<E> implements Cursored, EventSequencer<E>, EventSink<E> {
     ...
     */
    public RingBufferArray(final EventFactory<E> eventFactory, final Sequencer sequencer) {
     ...
     */
    public static <E> RingBufferArray<E> createMultiProducer(final EventFactory<E> factory, final int bufferSize, final WaitStrategy waitStrategy) {
     ...
     */
    public static <E> RingBufferArray<E> createSingleProducer(final EventFactory<E> factory, final int bufferSize, final WaitStrategy waitStrategy) {
     ...
     * @throws IllegalArgumentException if bufferSize is less than 1 or not a power of 2
     */
    public static <E> RingBufferArray<E> create(final ProducerType producerType, final EventFactory<E> factory, final int bufferSize, final WaitStrategy waitStrategy) {
        switch(producerType) {
            case SINGLE:
