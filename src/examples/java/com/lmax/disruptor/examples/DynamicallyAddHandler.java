...
public class DynamicallyAddHandler {
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        BatchEventProcessor<StubEvent> processor1 = new BatchEventProcessorBuilder().build(ringBuffer, ringBuffer.newBarrier(), handler1);
        DynamicHandler handler2 = new DynamicHandler();
        BatchEventProcessor<StubEvent> processor2 = new BatchEventProcessorBuilder().build(ringBuffer, ringBuffer.newBarrier(processor1.getSequence()), handler2);
