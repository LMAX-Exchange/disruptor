...
public class RingBufferBenchmark {
    ...
    public static class StateRingBufferUnsafe {
        ...
        RingBufferUnsafe<Object> ringBufferUnsafe = new RingBufferUnsafe<>(() -> new StubEvent(-1), new SingleProducerSequencer(128, new DummyWaitStrategy()));
    }
    ...
    public static class StateRingBufferArray {
        ...
        RingBufferArray<Object> ringBufferVarHandle = new RingBufferArray<>(() -> new StubEvent(-1), new SingleProducerSequencer(128, new DummyWaitStrategy()));
    }
    ...
    public static void main(final String[] args) throws RunnerException {
        Options opt = new OptionsBuilder().include(RingBufferBenchmark.class.getSimpleName()).build();
        new Runner(opt).run();
    }
}
