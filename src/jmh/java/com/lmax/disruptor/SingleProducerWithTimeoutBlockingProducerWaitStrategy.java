...
@State(Scope.Thread)
@Fork(1)
public class SingleProducerWithTimeoutBlockingProducerWaitStrategy
{
    ...
    public void setup(final Blackhole bh)
    {
        disruptor = new Disruptor<>(SimpleEvent::new,
                ...
                new TimeoutBlockingProducerWaitStrategy(5, TimeUnit.MINUTES));
    ...
    public static void main(final String[] args) throws RunnerException
    {
        Options opt = new OptionsBuilder()
                .include(SingleProducerWithTimeoutBlockingProducerWaitStrategy.class.getSimpleName())
                .forks(1)
                .build();
        new Runner(opt).run();
    }
