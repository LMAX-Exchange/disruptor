...
public final class OneToThreePipelineSequencedThroughputTest extends AbstractPerfTestDisruptor {
    ...
    private final BatchEventProcessor<FunctionEvent> stepOneBatchProcessor = new BatchEventProcessorBuilder().build(ringBuffer, stepOneSequenceBarrier, stepOneFunctionHandler);
    ...
    private final BatchEventProcessor<FunctionEvent> stepTwoBatchProcessor = new BatchEventProcessorBuilder().build(ringBuffer, stepTwoSequenceBarrier, stepTwoFunctionHandler);
    ...
    private final BatchEventProcessor<FunctionEvent> stepThreeBatchProcessor = new BatchEventProcessorBuilder().build(ringBuffer, stepThreeSequenceBarrier, stepThreeFunctionHandler);
