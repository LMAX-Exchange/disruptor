...
public final class PingPongSequencedLatencyTest {
    ...
    private final BatchEventProcessor<ValueEvent> pingProcessor = new BatchEventProcessorBuilder().build(pongBuffer, pongBarrier, pinger);

    private final SequenceBarrier pingBarrier = pingBuffer.newBarrier();

    private final Ponger ponger = new Ponger(pongBuffer);

    private final BatchEventProcessor<ValueEvent> pongProcessor = new BatchEventProcessorBuilder().build(pingBuffer, pingBarrier, ponger);
