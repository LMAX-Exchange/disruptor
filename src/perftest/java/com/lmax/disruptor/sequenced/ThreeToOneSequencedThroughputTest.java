...
import static com.lmax.disruptor.RingBuffer.createWaitFreeMultiProducer;
...
public final class ThreeToOneSequencedThroughputTest extends AbstractPerfTestDisruptor
{
    ...
    private final RingBuffer<ValueEvent> ringBuffer =
        createWaitFreeMultiProducer(ValueEvent.EVENT_FACTORY, BUFFER_SIZE, new BusySpinWaitStrategy(), 64);
